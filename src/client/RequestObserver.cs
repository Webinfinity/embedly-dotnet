...
namespace Embedly
{
	...
	internal class RequestObserver : IObserver<UrlRequest>
	{
		...
		private readonly ISubject<Result> _cachedResults;
		private readonly ISubject<UrlRequest> _downloadRequired;
		private readonly ISubject<Result> _downloadedResults;
		...
		{
			_cache = client.Cache;
			_cachedResults = new AsyncSubject<Result>();
			_downloadedResults = new AsyncSubject<Result>();
